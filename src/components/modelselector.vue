...
<template>
  ...
  <div class="column gutter-sm">
    ...
    <div class="row">
      <div class="col-10">
        <q-btn
          @click="resetBlockFormFields();createBlockStep = 1"
          align="left"
    ...
    >
      ...
      >
        ...
        >
          ...
          <q-stepper-navigation>
            <q-btn
              :disabled="cleanBlockName() == ''"
              @click="createBlockStep = 2"
              color="green"
              label="Next"
            ></q-btn>
          </q-stepper-navigation>
        ...
        >
          ...
          <q-radio
            ...
            val="custom_step"
            label="Use the settings from a DHF custom step"
          ></q-radio>
          ...
          <q-radio
            ...
            v-model="blockSourceOption"
            val="db_collection"
            label="Sample the documents in a database collection"
          ></q-radio>
          ...
          <q-radio
            ...
            v-model="blockSourceOption"
            val="none"
            label="Do not use fields from existing data. You can still add custom fields"
          ></q-radio>
          ...
          <div class="row">
            ...
            >
              <q-checkbox
                color="blue"
                v-model="showCustomURIPanel"
              >Add fields from specific document(s) in the database</q-checkbox>
            </div>
            <div
              class="col-1"
              align="right"
            >
              <q-icon
                :color="collectionSamplingStatus[1]"
          ...
          <div v-if="showCustomURIPanel">
            <q-input
              bottom-slots
              v-model="customURI"
              label="Document URI (can enter multiple, space separated)"
              @keydown.enter.prevent="addURIToList"
            >
              ...
              >
                ...
                <q-item-section avatar>
                  ...
                  >
                    <q-tooltip
                      ...
                      v-if="!item.exists"
                    >No document with this URI exists in the database so fields will not be available</q-tooltip>
                  </q-icon>
                </q-item-section>
                <q-item-section>
                  {{ item.uri }}
                ...
                <q-item-section side>
                  <q-btn
                    ...
                    dense
                    icon="remove"
                    @click="removeURIFromList(item.uri)"
                  >
          ...
          <q-stepper-navigation>
            <q-btn
              @click="createBlockStep = 1"
              color="primary"
              label="Back"
              class="q-ml-sm"
            ></q-btn>
            <q-btn
              :disabled="! dataSourceNextOk"
              @click="createBlockStep = 3"
              color="green"
              label="Next"
              class="q-ml-sm"
            ></q-btn>
        ...
        >
            ...
            >
              ...
              <div class="row">
                <div class="col-2">
                  ...
                  >
                    <q-icon
                      style="font-size: 1.5em;padding: 0px; margin: 0px;"
                      name="fas fa-minus"
                      @click="$refs.selectionTree.collapseAll()"
                    >
                ...
                <div class="col-2">
                  ...
                  >
                    <q-icon
                      ...
                      @click="$refs.selectionTree.expandAll()"
                    >
          ...
          <div>
            <q-tooltip
              v-if="this.selectedFields.length == 0"
              content-style="pipes-tooltip"
            >
            ...
            <q-stepper-navigation>
              ...
              <q-btn
                :disabled="this.selectedFields.length < 1"
      ...
      { label: 'Create field outputs', value: 'fieldsOutputs' }
              ...
              <q-checkbox
                dense
                v-model="userRequestingBlockOptionHelp"
                @input="blockHelpOnOff"
              >
                Explain options
                <q-tooltip
                  anchor="bottom right"
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          <ul class="userfield-right">
                            <li
                              :class="outputItem.class"
                              v-for="outputItem in this.stepBlockFieldsOutput"
                              :key="outputItem.label"
                            >
          ...
          <q-stepper-navigation>
            <q-tooltip
              v-model="explainBlockNotReady"
              :disabled="this.createBlockReady"
              content-class="pipes-tooltip"
            >
    ...
    >
      <q-list padding>
        ...
        <q-item
          tag="label"
          v-for="(block, index) in this.sourceBlocks"
          v-bind:key="block.source + '/' + block.label"
        ...
        >
          ...
          >
            <q-btn
              :disabled="! block.metadata || ! block.metadata.blockCreatedFrom || block.metadata.blockCreatedFrom === null"
              @click.capture.stop="restoreBlockToForm(block)"
              flat
              outline
              size="sm"
              style="color: #419e5a"
          ...
          >
            <q-btn
              @click.capture.stop="deleteBlock(block,true)"
              flat
              outline
              size="sm"
              style="color: #b81220"
