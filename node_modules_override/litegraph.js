...
*/
  ...
  function docByKey () {
    ...
    this.addProperty("Template", "cts.andQuery([cts.collectionQuery('/otherCollection'),cts.jsonPropertyValueQuery('theKey',${id})])");

  }



  docByKey.title = "Get Doc by ID";
  docByKey.desc = "Get other doc by ID";





  docByKey.prototype.onExecute = function () {
    let id = this.getInputData(0)

    let template = "`" + this.properties.Template + "`"
    let queryStr = eval(template)
    let query = eval(queryStr)
    let result = fn.head(cts.search(query))
    this.setOutputData(0, result);
  }


  LiteGraph.registerNodeType("feature/Doc By Key", docByKey);
  ...
  function stringTemplate () {
    ...
    this.v5 = this.addWidget("text", "v4", "v4", function (v) { }, {});
    this.v6 = this.addWidget("text", "v5", "v5", function (v) { }, {});
  ...
  TestWidgetsNode.title = "Hash Node content";
  ...
  function TestWidgetsNode () {
    this.addInput("clientId", null);
    this.addOutput("result", "number");
    this.properties = {};
    var that = this;
    this.slider = this.addWidget("slider", "Last # days", 365, function (v) { }, { min: 0, max: 1000 });
    this.combo = this.addWidget("combo", "Operation", "sum", function (v) { }, { values: ["sum", "avg", "min", "max", "count"] });
    this.combo = this.addWidget("combo", "Data", "Amount", function (v) { }, { values: ["TransactionDate", "Amount", "Discount"] });
    this.size = this.computeSize();
    this.serialize_widgets = true;
  }

  TestWidgetsNode.title = "Transaction stats*";

  LiteGraph.registerNodeType("feature/widgets", TestWidgetsNode);
