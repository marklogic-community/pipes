      ...
      if( node && this.allow_interaction && !skip_action )
      {
        ...
        if(!skip_action)
        {
          ...
          if (is_double_click && this.selected_nodes[ node.id ])
          {
            //double click node
            if( node.onDblClick)
              node.onDblClick(e,[e.canvasX - node.pos[0], e.canvasY - node.pos[1]],node);
...
//called if the graph doesnt have a default drop item behaviour
  ...
  LGraphCanvas.onShowMenuNodeProperties = function( value, options, e, prev_menu, node )
  {
    ...
    function inner_clicked( v, options, e, prev )
    {
      ...
      canvas.showEditPropertyValue( node, v.value, { position: [300, 300] }); // [rect.left, rect.top] });
    }
...
//register in the system
  ...
  LiteGraph.wrapFunctionAsNode('dm/coalesce',coalesce,
  ...
  function TestWidgetsNode()
  {
    ...
    this.combo = this.addWidget("combo","Operation", "Amount", function(v){}, { values:["TransactionDate","Amount","Discount"]} );
    this.size = this.computeSize();
