...
*/
  ...
  LGraphCanvas.prototype.prompt = function (title, value, callback, event) {
    ...
    if (event) {
      dialog.style.left = offsetx + "px";
      dialog.style.top = event.clientY * 0.5 + offsety + "px";
    } else {
      dialog.style.left = offsetx + "px";
      dialog.style.top = canvas.height * 0.2 + offsety + "px";
    }
...
(function (global) {
  ...
  Subgraph.prototype.onDrawBackground = function (ctx) {
    //show the current value
    if (!this.inputs[0].name.includes("[List]")) this.inputs[0].label = this.inputs[0].name + " [List]"
    if (!this.outputs[0].name.includes("[List]")) this.outputs[0].label = this.outputs[0].name + " [List]"
  };
  ...
  GraphOutput.prototype.onConfigure = function () {
    // this.updateType();
  }
