...
//no need to define node.configure, the default method detects node.subgraph and passes the object to node.subgraph.configure()
  ...
  function GraphInput() {
    ...
    let randomName ="Rename_" +String(Math.round(Math.random() *100)).padStart(3,'0')
    this.addOutput("", "");
    this.name_in_graph = null;
    this.properties = {
      name: "",
      type: "",
      value: 0
    ...
    //this.setProperty("name",randomName)
    setTimeout(function(){
      if(this.properties.name=="")
        this.onPropertyChanged("name",randomName) }.bind(this), 500);
...
*/
  ...
  function GraphInput() {
    ...
    Object.defineProperty(this.properties, "name", {
      ...
      set: function(v) {
        ...
        if (that.name_in_graph) {
          ...
          if(v=="item from item(s)")
            that.graph.addInput("item from item(s)", null);
          else
    ...
    this.name_widget = this.addWidget(
      ...
      function(v) {
        ...
        if(that.name_in_graph!="item from item(s)") {
          that.properties.name = v;
          that.name_widget.value = v
        }
        else {
          that.properties.name = "item from item(s)"
          that.name_widget.value = "item from item(s)"
    ...
    setTimeout(function(){
      if(this.properties.name==""){
        ...
        if(!this.graph.inputs["item from item(s)"]) {
          randomName = "item from item(s)"

        }
        else
          randomName ="Rename_" +String(Math.round(Math.random() *100)).padStart(3,'0')
  ...
  GraphInput.prototype.onKeyUp= function(key){
    console.log(key)
    console.log("key")
    if(key.key=="d")
      this.ignore_remove=false
  ...
  function GraphOutput() {
    ...
    Object.defineProperty(this.properties, "name", {
      ...
      set: function(v) {
        ...
        if (that.name_in_graph) {
          ...
          if(v=="result item")
            that.graph.addOutput("result item", null);
          else
    ...
    this.name_widget = this.addWidget(
      ...
      function(v) {
        ...
        if(that.name_in_graph!="result item")
          that.properties.name = v;
        else {
          that.properties.name = "result item"
          that.name_widget.value = "result item"
    ...
    setTimeout(function(){
      if(this.properties.name==""){
        ...
        if(!this.graph.outputs["result item"]) {
          randomName = "result item"
          that.ignore_remove=true
        }
        else
          randomName ="rename_" +String(Math.round(Math.random() *100)).padStart(3,'0')
        this.properties.name = randomName;
