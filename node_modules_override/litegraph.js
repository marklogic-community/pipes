...
*/
  ...
  LGraphCanvas.onMenuAdd = function (node, options, e, prev_menu) {
    ...
    function inner_clicked (v, option, e) {
      console.log("Adding menu children")
  ...
  LGraphCanvas.prototype.processContextMenu = function (node, event) {
    ...
    function inner_option_clicked (v, options, e) {
      ...
      console.log("In inner_option_clicked")
  ...
  Subgraph.description = "Node containing a further graph";
      ...
      set: function (v) {
        ...
        if (!that.properties.isMain) {
          ...
          if (that.name_in_graph) {
            ...
            that.graph.addInput(v + " [List]", null);
            that.name_in_graph = v + " [List]";
  ...
  GraphInput.description = "Input of the graph";
      ...
      set: function (v) {
        ...
        if (!that.properties.isMain) {
          ...
          if (that.name_in_graph) {
            ...
            that.graph.addOutput(v + " [List]", null);
            that.name_in_graph = v + " [List]";
  ...
  GraphOutput.description = "Output of the graph";
...
(function (global) {
  ...
  GraphInputDHF.description = "Input of the graph";
  ...
  GraphOutputObjectDHF.description = "DHF output object";
  ...
  GraphOutputDHF.description = "Output of the graph";
...
(function (global) {
  ...
  currentDate.description = "Outputs current date(time)";
  ...
  function selectCase () {
    ...
    this.addProperty("testCasesStr", "")
    this.addProperty("testCases", "")
    this.addOutput("result", null);

    var that = this;
    this.slider = this.addWidget("text", "nbInputs", 1, function (v) {

      for (let i = 0; i < this.inputs.length; i++) this.removeInput("input" + i, null)
      this.addInput("value2Test", null);
      for (let i = 0; i < parseInt(v); i++) this.addInput("input" + i, null)

    }.bind(this), { min: 0, max: 1000 });
    this.size = this.computeSize();
    this.serialize_widgets = true;
  }

  selectCase.title = "Select case";
